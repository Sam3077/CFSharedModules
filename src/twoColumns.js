...
class TwoColumns extends React.Component {
  ...
  render() {
    const { leftContent, rightContent, backgroundColor, rightColor, leftColor, middleSpace, width, leftPadding, rightPadding } = this.props;
    var widthToSet = '80vw';
    var direction = 'row';
    var middle = '0px';
    var leftToSet;
    ...
    return(
      <WrapperDiv
        ...
        >
        <Div
          background={leftToSet}
          padding={leftPadding}
          >
          {leftContent}
        </Div>
        <div style={{width: middle}}></div>
        <Div
          background={rightToSet}
